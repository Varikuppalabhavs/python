...
lb1=Label(mw,text="TO-DO LIST",bg="skyblue",font="arial",width=38,height=5)
lb1.pack(padx=0,pady=10)
lb2=Label(mw,text="Add Tasks")
lb2.place(x=50,y=150)
lb3=Label(mw,text="To-do Tasks")
lb3.place(x=40,y=220)

e1=Entry(mw,text="",width=20)
e1.place(x=20,y=180)

b1=Button(mw,text="Add",bg="yellow",command=add,width=15,height=2)
